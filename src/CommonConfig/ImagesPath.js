const ImagesPath = {
    ...
    logout : require('../Assets/Icons/drawer/dlogout.png'),
    sellerIcon : require('../Assets/Icons/drawer/seller.png'),
    settingIcon : require('../Assets/Icons/drawer/setting.png'),
    inviteIcon : require('../Assets/Icons/drawer/inviteIc.png'),
    contactUsIcon : require('../Assets/Icons/drawer/contactUs.png'),
    menuIcon : require('../Assets/Icons/drawer/menu.png'),
    barcodeIcon : require('../Assets/Icons/drawer/barcode.png'),
    ...
    //SCREENS ICONS
    emailIcon : require('../Assets/Icons/invite/email.png'),
    facebookIcon : require('../Assets/Icons/invite/facebook.png'),
    telegramIcon : require('../Assets/Icons/invite/telegram.png'),
    ...
    inviteReferIcon : require('../Assets/Icons/home/inviteRefer.png'),
    paymentSuccessFullIcon : require('../Assets/Icons/home/paymentSuccessFull.png'),
    RidyLogoicon : require('../Assets/Icons/home/iTunesArtwork.png'),
    
    
    //examples
    MenuIcon: require('../Assets/Icons/menu.png'),
    HomeActiveIcon: require('../Assets/Icons/homeActive.png'),
    HomeInActiveIcon: require('../Assets/Icons/homeInactive.png'),
    StoriesActiveIcon: require('../Assets/Icons/heartActive.png'),
    StoriesInActiveIcon: require('../Assets/Icons/heartInactive.png'),
    CameraRoundIcon: require('../Assets/Icons/camera.png'),
    PeopleActiveIcon: require('../Assets/Icons/peopleActive.png'),
    PeopleInActiveIcon: require('../Assets/Icons/peopleInactive.png'),
    SettingsActiveIcon: require('../Assets/Icons/settingsActive.png'),
    SettingsInActiveIcon: require('../Assets/Icons/settingsInactive.png'),
